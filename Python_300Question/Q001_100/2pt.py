...
#My solution
시가총액 = 298,000,000,000,000 #오답 -> tuple로 인식한다.
현재가 = 50000
PER = 15.79
#------------check-------------
...
#013 문자열 출력 변수 s와 t에는 각각 문자열이 바인딩 되어있습니다.
# >> s = "hello" 
# >> t = "python" 
...
num_str = "720"
num_str = 720
#(int)num_str #-> c언어오 같은 다른 언어와 달리 int가 함수처럼 사용 되어야 한다.
print(type(num_str))
...
#My solution
num = 100
#num = string(num) #-> string이 아닌 str이다.
print(type(num))

    #solution
num = 100
num = str(num) #result = str(num)
print(num, type(num)) #print(result, type(result))
